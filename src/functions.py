...
def copy_static_to_public():
    ...
    for root, dirs, files in os.walk(source):
        ...
        destination_directory = os.path.join(destination, os.path.relpath(root, source))
        ...
        for file in files:
            ...
            shu.copy2(source_file, destination_file)
...
def generate_page(from_path, template_path, dest_path):
    ...
    if directory:  # Only try to create if there's a directory path
